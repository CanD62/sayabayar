...
function PaymentToast() {
  ...
  function scheduleShow(mode = 'normal') {
    ...
    hideTimer.current = setTimeout(() => {
      ...
      if (rng < 0.20) {
        nextMode = 'burst'
        gapMs = 2000 + Math.random() * 4000
      } else if (rng < 0.70) {
        nextMode = 'normal'
        gapMs = 10000 + Math.random() * 15000
      } else {
        nextMode = 'quiet'
        gapMs = 30000 + Math.random() * 30000
      }
    ...
    <div className="lp">
      ...
      <nav className="lp-nav" aria-label="Navigasi utama">
        <div className="lp-container lp-nav-inner">
          <Link href="/" className="lp-logo" aria-label="Saya Bayar — Beranda">
      ...
      <section className="lp-hero" aria-labelledby="hero-heading">
        <div className="lp-container">
          ...
          <div className="lp-hero-actions">
            <Link href="/register" className="btn btn-primary btn-lg" id="cta-hero-register">
              Mulai Gratis Sekarang <ArrowRight size={18} />
            </Link>
            <a href="#cara-kerja" className="btn btn-ghost btn-lg" id="cta-hero-how">
              Lihat Cara Kerja
            </a>
          </div>
          <div className="lp-hero-stats" aria-label="Statistik platform">
            {STATS.map(s => (
      ...
      {/* ── Masalah ──────────────────────────────── */}
      <section className="lp-section lp-section-problem" id="masalah" style={{ paddingBottom: 0 }} aria-labelledby="masalah-heading">
        <div className="lp-container">
          <div className="lp-section-header">
            <h2 id="masalah-heading" className="lp-section-title">Masih Cek Mutasi Satu-Satu Setiap Hari?</h2>
      ...
      {/* ── Cara Kerja ───────────────────────────── */}
      <section className="lp-section lp-section-steps" id="cara-kerja" aria-labelledby="cara-kerja-heading">
        <div className="lp-container">
          <div className="lp-section-header">
            <h2 id="cara-kerja-heading" className="lp-section-title">Simpel. 3 Langkah. Selesai.</h2>
            <p className="lp-section-subtitle">Tidak perlu teknis. Tidak perlu setting ribet. Langsung bisa digunakan.</p>
          </div>
          <ol className="lp-steps" aria-label="Langkah-langkah penggunaan">
            {STEPS.map((step, i) => {
              const StepIcon = step.icon
              return (
                <li key={step.num} className="lp-step">
                  <div className="lp-step-num" aria-hidden="true">{step.num}</div>
                  <div className="lp-step-icon" aria-hidden="true"><StepIcon size={28} /></div>
                  <h3 className="lp-step-title">{step.title}</h3>
                  <p className="lp-step-desc">{step.desc}</p>
                  {i < STEPS.length - 1 && <div className="lp-step-arrow" aria-hidden="true"><ArrowRight size={20} /></div>}
                </li>
              )
            })}
          </ol>
      ...
      {/* ── Fitur ────────────────────────────────── */}
      <section className="lp-section lp-section-features" id="fitur" aria-labelledby="fitur-heading">
        <div className="lp-container">
          <div className="lp-section-header">
            <h2 id="fitur-heading" className="lp-section-title">Semua yang Anda Butuhkan</h2>
            ...
            {FEATURES.map(f => {
              ...
              return (
                <article key={f.title} className="lp-feature-card">
                  <div className="lp-feature-icon" aria-hidden="true"><Icon size={24} /></div>
      ...
      {/* ── Trust / Security ─────────────────────── */}
      <section className="lp-section lp-section-security" id="keamanan" aria-labelledby="keamanan-heading">
        <div className="lp-container">
          <div className="lp-section-header">
            <h2 id="keamanan-heading" className="lp-section-title">Keamanan &amp; Transparansi</h2>
          ...
          <div className="lp-features" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
            <article className="lp-feature-card">
              <div className="lp-feature-icon" aria-hidden="true"><Shield size={24} /></div>
            ...
            <article className="lp-feature-card">
              <div className="lp-feature-icon" aria-hidden="true"><CheckCircle size={24} /></div>
            ...
            <article className="lp-feature-card">
              <div className="lp-feature-icon" aria-hidden="true"><Zap size={24} /></div>
            ...
            <article className="lp-feature-card">
              <div className="lp-feature-icon" aria-hidden="true"><TrendingUp size={24} /></div>
      ...
      {/* ── Pricing ──────────────────────────────── */}
      <section className="lp-section lp-section-pricing" id="harga" aria-labelledby="harga-heading">
        <div className="lp-container">
          <div className="lp-section-header">
            <h2 id="harga-heading" className="lp-section-title">Harga Transparan, Tanpa Kejutan</h2>
          ...
          <div className="lp-pricing">
            ...
            <div className="lp-pricing-card">
              ...
              <ul className="lp-pricing-features" aria-label="Fitur paket Gratis">
              ...
              <Link href="/register" className="btn btn-ghost" id="cta-pricing-free" style={{ width: '100%', justifyContent: 'center' }}>
                Mulai Gratis
              </Link>
              <div style={{ height: 32 }} />
            </div>
            ...
            <div className="lp-pricing-card lp-pricing-card-featured">
              ...
              <Link href="/register" className="btn btn-primary" id="cta-pricing-pro" style={{ width: '100%', justifyContent: 'center' }}>
      ...
      {/* ── Testimonials ─────────────────────────── */}
      <section className="lp-section lp-section-testimonials" id="testimoni" aria-labelledby="testimoni-heading">
        <div className="lp-container">
          <div className="lp-section-header">
            <h2 id="testimoni-heading" className="lp-section-title">Kata Mereka yang Sudah Pakai</h2>
          ...
          <div className="lp-testimonials">
            {TESTIMONIALS.map(t => (
              <figure key={t.name} className="lp-testimonial-card">
                <div className="lp-testimonial-stars" aria-label="5 bintang">
                  {[...Array(5)].map((_, i) => <Star key={i} size={14} fill="var(--warning)" color="var(--warning)" aria-hidden="true" />)}
                </div>
                <blockquote>
                  <p className="lp-testimonial-text">"{t.text}"</p>
                </blockquote>
                <figcaption className="lp-testimonial-author">
                  <div className="lp-testimonial-avatar" aria-hidden="true">{t.avatar}</div>
                  <div>
      ...
      {/* ── FAQ ──────────────────────────────────── */}
      <section className="lp-section lp-section-faq" id="faq" aria-labelledby="faq-heading">
        <div className="lp-container">
          <div className="lp-section-header">
            <h2 id="faq-heading" className="lp-section-title">Pertanyaan yang Sering Ditanyakan</h2>
      ...
      <section className="lp-cta" aria-labelledby="cta-heading">
        <div className="lp-container" style={{ textAlign: 'center' }}>
          ...
          <Link href="/register" className="btn btn-primary btn-lg" id="cta-final-register">
      ...
      <footer className="lp-footer">
        ...
        <div className="lp-container">
          <div className="lp-footer-bottom">
            <span>© {new Date().getFullYear()} {APP} · sayabayar.com · All rights reserved.</span>
          </div>
        </div>
      </footer>
